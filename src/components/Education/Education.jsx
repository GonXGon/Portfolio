...
const Education = () => {
  ...
  return (
    <div className="education-container">
        <button class="btn-77" onClick={() => setOpen(!open)}>Education</button>
                    ...
                    <Row>
                        <Col>
                            <Card style={{ width: '18rem' }}>
                                ...
                                <Card.Body>
                                    <Card.Title>Maynooth Univercity</Card.Title>
                                    <Card.Text>
        ...
        <button class="btn-77" onClick={() => setExpopen(!expopen)}>Experience</button>
